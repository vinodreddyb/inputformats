...
public class MapSideJoinJob extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception {
	    ...
	    Path emp = new Path("/home/vinod/git/inputformats/inputformats/src/main/resources/join/emp.txt");
	    Path sal = new Path("/home/vinod/git/inputformats/inputformats/src/main/resources/join/sal.txt");
	    Path outputPath = new Path("/home/vinod/work/output/empjoin");
	    outputPath.getFileSystem(getConf()).delete(outputPath, true);
	    
	    MultipleInputs.addInputPath(job, emp,
	        KeyValueLongInputFormat.class, EmployeeJoinMapper.class);
	    MultipleInputs.addInputPath(job, sal,
	    		KeyValueLongInputFormat.class, SalJoinMapper.class);
